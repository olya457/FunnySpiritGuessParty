...
import {Joke, OnboardingPage, PartySituation, QuizQuestion, Story, TheaterRole, TheaterScene} from '../types';
...
export const onboardingPages: OnboardingPage[] = [
  ...
  {
    id: 'party',
    badge: 'HALLOWEEN THEATRE',
    badgeColor: '#ff7a13',
    title: 'Stage a\nSpooky Show!',
    description:
      'Draw secret monster roles, perform haunted scenes, drop director twists, and crown the funniest actor in the room.',
...
export const quizLevels: QuizQuestion[][] = Array.from({length: 30}, (_, levelIndex) =>
  Array.from({length: 5}, (_, questionIndex) => quizQuestions[(levelIndex * 5 + questionIndex) % quizQuestions.length]),
);
...
export const theaterRoles: TheaterRole[] = [
  {
    id: 'count-dracula',
    emoji: '🧛',
    name: 'Count Dracula',
    troupe: 'Velvet Villains',
    intro: 'A dramatic vampire who treats every tiny inconvenience like a royal betrayal.',
    voice: 'Slow, elegant, and offended by modern lighting.',
    movement: 'Sweep your cape, pause before every doorway, and never sit normally.',
    signatureLine: 'I did not come for blood. I came for better atmosphere.',
    secretGoal: 'Convince someone to invite you into the scene twice.',
  },
  {
    id: 'vampire-countess',
    emoji: '🧛‍♀️',
    ...
    troupe: 'Velvet Villains',
    intro: 'A proud aristocrat who treats every conversation like a midnight negotiation.',
    voice: 'Smooth, cold, and amused by human panic.',
    movement: 'Glide slowly, lift one eyebrow, and turn away before answering.',
    signatureLine: 'Darling, fear is simply etiquette with sharper teeth.',
    secretGoal: 'Make another player ask your permission before continuing.',
  },
  {
    id: 'stage-witch',
    emoji: '🧙‍♀️',
    name: 'Stage Witch',
    troupe: 'Moonlit Stagecraft',
    intro: 'A perfectionist witch who believes every spell needs blocking and emotional truth.',
    voice: 'Quick, sharp, and theatrical.',
    movement: 'Draw shapes in the air like you are moving actors with invisible strings.',
    signatureLine: 'Again, but this time with feeling and fewer frogs.',
    secretGoal: 'Correct another player as if they missed rehearsal.',
  },
  {
    id: 'werewolf-poet',
    emoji: '🐺',
    name: 'Werewolf Poet',
    troupe: 'Full Moon Romantics',
    intro: 'A sensitive werewolf who turns every problem into a heartfelt poem.',
    voice: 'Soft and sincere until the moon is mentioned.',
    movement: 'Clutch your heart, then suddenly sniff the air for drama.',
    signatureLine: 'I howl because language is not enough.',
    secretGoal: 'Describe one ordinary object as if it broke your heart.',
  },
  {
    id: 'ancient-mummy',
    emoji: '🧟',
    name: 'Ancient Mummy',
    troupe: 'Royal Tomb Ensemble',
    intro: 'A slow but dramatic royal guard who remembers every insult from the last three thousand years.',
    voice: 'Dry, ancient, and offended by rushing.',
    movement: 'Step carefully, hold your arms stiff, and turn your whole body to look at people.',
    signatureLine: 'I crossed centuries for this, so please speak clearly.',
    secretGoal: 'Demand an apology for something that happened long ago.',
  },
  {
    id: 'frankenstein-monster',
    emoji: '⚡',
    name: "Frankenstein's Monster",
    troupe: 'Electric Cuisine',
    intro: 'A gentle giant learning feelings faster than everyone else can explain them.',
    voice: 'Booming, proud, and delighted by mistakes.',
    movement: 'Move in bold heavy steps, then become unexpectedly delicate.',
    signatureLine: 'I was made in lightning, but I still choose kindness.',
    secretGoal: 'Turn a scary moment into something surprisingly sweet.',
  },
  {
    id: 'phantom-singer',
    emoji: '🎭',
    name: 'Phantom Singer',
    troupe: 'Opera Cellar',
    intro: 'A masked performer who turns tiny problems into tragic musical moments.',
    voice: 'Melodic, wounded, and far too intense.',
    movement: 'Hide half your face, reach toward the ceiling, and freeze after big lines.',
    signatureLine: 'The music understands what the living cannot.',
    secretGoal: 'Sing or rhythmically speak one important sentence.',
  },
  {
    id: 'mad-scientist',
    emoji: '🥼',
    name: 'Mad Scientist',
    troupe: 'Storm Laboratory',
    intro: 'A brilliant experimenter who is always one bad idea away from applause.',
    voice: 'Fast, excited, and proud of dangerous logic.',
    movement: 'Point at invisible equipment and laugh before the result is clear.',
    signatureLine: 'Science says probably not, but theatre says absolutely yes.',
    secretGoal: 'Explain one absurd event as if it is a successful experiment.',
  },
  {
    id: 'zombie-prom-king',
    emoji: '🧟',
    name: 'Zombie Prom King',
    troupe: 'Undead Academy',
    intro: 'A charming zombie who remembers dance steps better than words.',
    voice: 'Slow, proud, and unexpectedly romantic.',
    movement: 'Shuffle like a dance move, bow deeply, and point to an imaginary crown.',
    signatureLine: 'Brains are nice, but tonight I choose rhythm.',
    secretGoal: 'Invite someone into a dramatic dance or slow-motion pose.',
  },
  {
    id: 'gothic-detective',
    emoji: '🕵️',
    name: 'Gothic Detective',
    troupe: 'Noir Night Watch',
    intro: 'A detective who sees mystery in every object and trusts nobody with clean shoes.',
    voice: 'Low, suspicious, and dramatic about simple clues.',
    movement: 'Lean into corners, point at evidence, and narrow your eyes at everyone.',
    signatureLine: 'The clue was obvious. That is why I almost missed it.',
    secretGoal: 'Accuse the wrong object with total confidence.',
  },
  {
    id: 'grim-reaper',
    emoji: '💀',
    name: 'Grim Reaper',
    troupe: 'Final Curtain Company',
    intro: 'A formal collector of endings who secretly wants better small talk.',
    voice: 'Deep, patient, and awkwardly polite.',
    movement: 'Stand very still, then point slowly like the room owes you silence.',
    signatureLine: 'Do not worry. I am only here for the dramatic ending.',
    secretGoal: 'Announce an ending that makes the scene continue instead.',
  },
  {
    id: 'pirate-ghost',
    emoji: '🏴‍☠️',
    name: 'Pirate Ghost',
    troupe: 'Cursed Deck Players',
    intro: 'A sea captain who lost the ship, the map, and possibly the plot.',
    voice: 'Bold, rough, and suspicious of furniture.',
    movement: 'Swagger, scan the horizon, and guard invisible treasure.',
    signatureLine: 'Aye, the curse is real, but the paperwork is worse.',
    secretGoal: 'Claim that one object is treasure and refuse to surrender it.',
  },
  {
    id: 'banshee-diva',
    emoji: '🎤',
    name: 'Banshee Diva',
    troupe: 'Midnight Cabaret',
    intro: 'A dramatic singer whose whisper can stop a room and whose scream is reserved for reviews.',
    voice: 'Elegant, emotional, and ready to become loud.',
    movement: 'Hold an invisible microphone and take a bow after every strong sentence.',
    signatureLine: 'I do not scream. I project destiny.',
    secretGoal: 'Turn one line into a performance announcement.',
  },
  {
    id: 'circus-ringmaster',
    emoji: '🎪',
    name: 'Circus Ringmaster',
    troupe: 'Night Carnival',
    intro: 'A showman who introduces every disaster like the greatest act on earth.',
    voice: 'Bright, booming, and impossible to ignore.',
    movement: 'Sweep one arm wide, step into the center, and sell the moment.',
    signatureLine: 'Ladies and gentlemen, the impossible has arrived late.',
    secretGoal: 'Introduce another player as if they are a dangerous attraction.',
  },
  {
    id: 'masked-magician',
    emoji: '🎩',
    name: 'Masked Magician',
    troupe: 'Impossible Parlour',
    intro: 'A charming illusionist whose tricks work, but never in the intended order.',
    voice: 'Confident, playful, and secretly worried.',
    movement: 'Present invisible cards, snap your fingers, and pretend mistakes were planned.',
    signatureLine: 'Nothing has gone wrong until I admit it.',
    secretGoal: 'Make an object, excuse, or person "disappear" from the story.',
  },
];

export const theaterScenes: TheaterScene[] = [
  {
    id: 'castle-open-house',
    actTitle: 'Open House at Castle Dracula',
    scene: 'The castle is hosting a midnight open house, but every room is haunted by a different bad review.',
    prop: 'A velvet guest book that writes insults by itself.',
    direction: 'Perform the scene as if you are trying to impress very judgmental ghosts.',
    twist: 'The chandelier suddenly becomes the host and demands introductions.',
    challenge: 'Say one sentence as a whisper, then repeat it as a royal announcement.',
    applauseCue: 'Audience applauds when someone says "midnight".',
  },
  {
    id: 'monster-pageant',
    actTitle: 'The Great Monster Pageant',
    scene: 'A Halloween pageant is about to begin, but every monster claims the spotlight at once.',
    prop: 'A glitter crown that chooses its own monarch.',
    direction: 'Treat every prop like it is emotionally fragile.',
    twist: 'A judge reveals that the prize is one haunted wish with fine print.',
    challenge: 'Give a dramatic compliment to a rival performer without using the word scary.',
    applauseCue: 'Audience makes a drumroll before the winner is named.',
  },
  {
    id: 'witch-rehearsal',
    actTitle: 'Last Rehearsal Before the Curse',
    scene: 'A theatre troupe has one hour to rehearse a curse-breaking play, but nobody remembers the ending.',
    prop: 'A script that changes genre every time someone blinks.',
    direction: 'Switch between serious theatre and chaotic comedy without warning.',
    twist: 'The curse only breaks if the villain gets a standing ovation.',
    challenge: 'Deliver one line like Shakespeare and the next like a sports coach.',
    applauseCue: 'Audience snaps fingers whenever the script changes.',
  },
  {
    id: 'monster-talent-agency',
    actTitle: 'Monster Talent Agency',
    scene: 'The agency is auditioning monsters for a cereal commercial, but every monster wants to play the hero.',
    prop: 'A tiny microphone that makes lies sound musical.',
    direction: 'Pitch yourself like this is the most important audition of your afterlife.',
    twist: 'The cereal mascot arrives and is scarier than everyone.',
    challenge: 'Invent a catchphrase and make another player repeat it.',
    applauseCue: 'Audience cheers after each fake commercial slogan.',
  },
  {
    id: 'haunted-cafe',
    actTitle: 'Midnight Cafe Complaint Desk',
    scene: 'The cafe serves nightmares, but tonight every customer wants a refund and a warmer blanket.',
    prop: 'A receipt that lists emotional damages.',
    direction: 'Keep the scene polite, even when everything becomes absurd.',
    twist: 'The coffee machine starts judging everyone by their aura.',
    challenge: 'Complain about something impossible as if it is normal customer service.',
    applauseCue: 'Audience says "approved" after the best complaint.',
  },
  {
    id: 'graveyard-weather',
    actTitle: 'The Graveyard Weather Report',
    scene: 'A live weather broadcast from the graveyard goes wrong when the fog starts giving interviews.',
    prop: 'A microphone covered in mysterious cobwebs.',
    direction: 'Play it like breaking news, even when the news is ridiculous.',
    twist: 'The forecast predicts a rain of tiny dramatic capes.',
    challenge: 'Report one terrifying thing in the calmest voice possible.',
    applauseCue: 'Audience makes wind sounds when the forecast changes.',
  },
  {
    id: 'costume-court',
    actTitle: 'Halloween Costume Court',
    scene: 'A courtroom decides whether a costume is too powerful to wear at a normal party.',
    prop: 'A glowing mask that objects to every sentence.',
    direction: 'Everyone must act like this trial will change history.',
    twist: 'The defendant is the costume itself.',
    challenge: 'Give one piece of evidence that makes no sense but sounds official.',
    applauseCue: 'Audience taps twice when someone says "objection".',
  },
  {
    id: 'moon-ballroom',
    actTitle: 'Ballroom on the Moon',
    scene: 'A moonlit dance begins, but gravity keeps choosing favorites.',
    prop: 'Silver shoes that dance away from responsibility.',
    direction: 'Move like the floor is sometimes there and sometimes not.',
    twist: 'The moon asks for the last dance and will not accept no.',
    challenge: 'Ask another player to dance using only monster logic.',
    applauseCue: 'Audience hums a waltz during awkward silence.',
  },
  {
    id: 'haunted-lost-found',
    actTitle: 'Lost and Found for Cursed Objects',
    scene: 'The theatre lost-and-found is full of cursed props, and one of them belongs to a player.',
    prop: 'A scarf that reveals secrets when tied badly.',
    direction: 'Treat each object like evidence in a glamorous mystery.',
    twist: 'The missing owner is watching from inside the prop box.',
    challenge: 'Explain why one cursed object is actually useful at parties.',
    applauseCue: 'Audience gasps whenever an object is named.',
  },
  {
    id: 'zombie-graduation',
    actTitle: 'Undead Graduation Night',
    scene: 'The zombie academy graduation is delayed because the valedictorian ate the speech notes.',
    prop: 'A diploma that keeps crawling away.',
    direction: 'Make every line sound inspirational, even the embarrassing ones.',
    twist: 'The principal announces a surprise exam in dramatic walking.',
    challenge: 'Give a motivational speech about a completely silly object.',
    applauseCue: 'Audience claps slowly like proud parents.',
  },
  {
    id: 'vampire-elevator',
    actTitle: 'Elevator to the Vampire Penthouse',
    scene: 'The elevator is stuck between floors with a vampire, a delivery bag, and one unspoken secret.',
    prop: 'A doorbell button labeled "Do Not Press Unless Fancy".',
    direction: 'Build suspense around very ordinary inconveniences.',
    twist: 'The elevator refuses to move until someone says please with flair.',
    challenge: 'Make a simple request sound like an ancient ritual.',
    applauseCue: 'Audience rings an imaginary bell when manners win.',
  },
  {
    id: 'oracle-costume-shop',
    actTitle: 'The Oracle Costume Shop',
    scene: 'A costume shop predicts everyone’s future, but only through dramatic accessories.',
    prop: 'A velvet hat that whispers career advice.',
    direction: 'Be mystical about costumes and practical about destiny.',
    twist: 'One prediction is about the audience instead of the actors.',
    challenge: 'Predict a future using a costume detail, weather, and one dramatic pause.',
    applauseCue: 'Audience says "stylish fate" after a prophecy.',
  },
  {
    id: 'attic-radio',
    actTitle: 'Broadcast from the Attic',
    scene: 'A haunted radio show takes calls from monsters who need advice before the Halloween party.',
    prop: 'A phone that rings only when nobody is ready.',
    direction: 'Speak like a late-night host who has heard everything.',
    twist: 'The next caller is someone’s future self wearing a costume.',
    challenge: 'Give sincere advice to a monster with a tiny problem.',
    applauseCue: 'Audience makes radio static before each call.',
  },
  {
    id: 'final-curtain',
    actTitle: 'The Final Curtain Refuses to Fall',
    scene: 'Opening night is ending, but the curtain has stage fright and will not close.',
    prop: 'A bouquet that applauds louder than the audience.',
    direction: 'Play the finale with maximum ceremony and one ridiculous confession.',
    twist: 'The curtain asks to perform a solo.',
    challenge: 'Thank the audience while secretly asking them for help.',
    applauseCue: 'Audience gives a tiny standing ovation at the end.',
  },
];
